...
from gehol.converters.icalwriter import  write_ical_to_file, convert_calendar_to_ics_rfc5545
...
def make_ical_from_url(name, url):
    ...
    ical_data = convert_calendar_to_ics_rfc5545(cal, first_monday)
    outfile = "%s.ics" % name
    print "writing ical file : %s" % outfile
    write_ical_to_file(ical_data, outfile)
